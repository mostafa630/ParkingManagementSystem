...
namespace ParkingManagementSystem
{
    internal class DataBase : IDataBase
    {
        ...
        {
            new Tariff(Guid.Parse("4f0c3b03-9b0b-4a13-b4f2-3aa5e66d0c42"), sites[0], 5.00m, 3.00m),
            new Tariff(Guid.Parse("8f0c3b03-9b0b-4a13-b4f2-3aa5e66d0c42"), sites[1], 6.00m, 4.00m)
        };
